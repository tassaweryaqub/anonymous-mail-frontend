...
import laptop from '../src/img/Vectary.png';
import rectangle from '../src/img/Rectangle.png';
import ellipse from '../src/img/Ellipse.png';
import line from '../src/img/Line.png';
import btn from '../src/img/CTA.png';
import box from '../src/img/box.png';
import downloadBtn from '../src/img/download-btn.png';
import windows from '../src/img/windows-logo.png';
import macos from '../src/img/apple-logo.png';
import linux from '../src/img/linux-logo.png';
  ...
  return (
      <div className={classes.root}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={4}>
            <img src={laptop} alt="laptop" width="350" height="250" className={classes.paper}/>
          </Grid>
        </Grid>
        ...
        <div>
            <a href="signup.js"><img src={btn} alt="button" className="btn"/></a>
        </div>
