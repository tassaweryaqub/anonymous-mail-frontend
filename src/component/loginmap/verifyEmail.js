...
export default function ButtonAppBar() {
  ...
  return (
    <div className={klassen.root}>
      ...
      <h2 className="vl">Verify Email</h2>
      <p className="enter-code">
        Please enter the code that you received in your mail box to start using Anonymous Email.
      </p>
      <input
        type="text"
      ...
      <footer className= "footer-verify-email">
