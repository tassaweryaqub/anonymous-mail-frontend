    ...
    return (
        <div>
            ...
            <TableContainer component={Paper}>
             ...
             {/*  button div */}
             <div>
                    <button className= "del1" type="button" onClick={handleOpen}><DeleteSharpIcon style = {{color: 'red', cursor: 'pointer'}}  />
                    </button>
                    <button className= "del2" type="button" onClick={handleOpen}><DeleteSharpIcon style = {{color: 'red', cursor: 'pointer'}}  />
                    </button>
                    <button className= "del3" type="button" onClick={handleOpen}><DeleteSharpIcon style = {{color: 'red', cursor: 'pointer'}}  />
                    </button>
                    <button className= "del4" type="button" onClick={handleOpen}><DeleteSharpIcon style = {{color: 'red', cursor: 'pointer'}}  />
                    </button>
                    <button className= "del5" type="button" onClick={handleOpen}><DeleteSharpIcon style = {{color: 'red', cursor: 'pointer'}}  />
                    </button>
                    <button className= "del6" type="button" onClick={handleOpen}><DeleteSharpIcon style = {{color: 'red', cursor: 'pointer'}}  />
                    </button>
                    <button className= "del7" type="button" onClick={handleOpen}><DeleteSharpIcon style = {{color: 'red', cursor: 'pointer'}}  />
                    </button>
                    
                    
                    <Modal style= {{left: '85ch',  width: 400, top: '190px'}}
                    ...
                    <Fade in={open}>
                        ...
                        <h3 id="transition-modal-title">Delete User</h3>
